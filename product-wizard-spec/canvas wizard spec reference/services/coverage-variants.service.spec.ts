...
import { CoverageVariantsService } from './coverage-variants.service';
import { 
  CoverageVariant, 
...
describe('apps/products/src/app/products/services/coverage-variants.service.spec.ts', () => {
  let service: CoverageVariantsService;
  let productContext: any;
  let httpClientSpy: any;
  let httpCacheManagerMock: any;
  ...
  const mockCreateCoverageVariant: CoverageVariant = {
    id: 'CV001',
    coverageVariantId: 'CV001',
    name: 'CVID1',
    isPeril: false,
  ...
  beforeEach(() => {
    ...
    service = new CoverageVariantsService(httpClientSpy, httpCacheManagerMock,
       referenceDataServiceMock, productContext, mockAppContextService);
  });
  ...
  it('should set default language to en when not provided', () => {
    ...
    const newService = new CoverageVariantsService(httpClientSpy, httpCacheManagerMock,
       referenceDataServiceMock, productContext, mockAppContextService);
  ...
  describe('createCoverageVariant', () => {
    ...
    it('should handle creation with minimal data', () => {
      const minimalData: CoverageVariant = {
        id: 'MIN001',
  ...
  describe('updateCoverageVariant', () => {
    it('should update coverage variant', () => {
      ...
      service.updateCoverageVariant(mockCreateCoverageVariant, 'CV001', '1', '1');
    ...
    it('should handle update with modified data', () => {
      ...
      service.updateCoverageVariant(modifiedData, 'CV001', '1', '1');
    });
    ...
    it('should handle undefined parameters in update', () => {
      ...
      service.updateCoverageVariant(mockCreateCoverageVariant, 'CV001', undefined, undefined);
  ...
  describe('deleteCoverageVariant', () => {
    it('should delete coverage variant', () => {
      ...
      service.deleteCoverageVariant('CV001');
  ...
  //     expect(() => {
  //       new CoverageVariantsService(httpClientSpy, httpCacheManagerMock,
  //      referenceDataServiceMock, productContext, mockAppContextService);
  //     }).not.toThrow();
  //   });
