...
import { SpouseVariantLevelComponent } from './spouse-variant-level.component';
...
describe('SpouseVariantLevelComponent', () => {
  let component: SpouseVariantLevelComponent;
  let fixture: ComponentFixture<SpouseVariantLevelComponent>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(SpouseVariantLevelComponent);
  ...
  it('_prefillSubCoverageForm should build controls based on subCoverage list', async () => {
    component.ngOnInit();
    const option = { code: InsuredTypeKeys.SPOUSE } as any;
  ...
  it('submitSubCoverages should patch and show success, error branch should also navigate', async () => {
    ...
    await component.submitSubCoverages(
      ...
      req,
      { value: InsuredTypeKeys.SPOUSE } as any,
      'CVL-1'
    );
    expect(mockLayoutService.showMessage).toHaveBeenCalled();
    // error
  ...
  it('should test _prepareCoverageFactorMapping', () => {
    const mockPayload = {
      insuredLevel: [
        {
          insuredType: { value: InsuredTypeKeys.SPOUSE },
          limit: { maxAmount: 1000 },
        },
      ],
    } as any;
  ...
  it('should test getSelectedOption method', () => {
    ...
    expect(result).toBeDefined();
    expect(result?.code).toBe(InsuredTypeKeys.SPOUSE);
  });
  ...
  it('should return SPOUSE from retrieveDataOptions if newRetrieveDataControl is empty', () => {
    component.retrieveDataOptions = [
      { code: InsuredTypeKeys.MAININSURED },
      { code: InsuredTypeKeys.SPOUSE },
    ] as any;
    component.newRetrieveDataControl = { value: '' } as any;
    expect(component.getSelectedOption()?.code).toBe(InsuredTypeKeys.SPOUSE);
  });
  ...
  it('should call submitSubCoverages if editedForm length > 0', async () => {
    ...
    component.activeInsuredType = { value: InsuredTypeKeys.SPOUSE } as any;
