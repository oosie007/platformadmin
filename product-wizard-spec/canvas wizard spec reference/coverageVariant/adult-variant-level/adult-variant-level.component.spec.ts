...
import { AdultVariantLevelComponent } from './adult-variant-level.component';
...
describe('AdultVariantLevelComponent', () => {
  let component: AdultVariantLevelComponent;
  let fixture: ComponentFixture<AdultVariantLevelComponent>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(AdultVariantLevelComponent);
  ...
  it('_prefillSubCoverageForm should build controls based on subCoverage list', async () => {
    component.ngOnInit();
    const option = { code: DependentTypeKeys.ADULT } as any;
  ...
  it('submitSubCoverages should patch and show success, error branch should also navigate', async () => {
    ...
    await component.submitSubCoverages(
      ...
      req,
      { value: DependentTypeKeys.ADULT } as any,
      'CVL-1'
    );
    expect(mockLayoutService.showMessage).toHaveBeenCalled();
    // error
  ...
  it('should test _navigateIndividualVariantLevels', () => {
    component.selectedInsuredTypes = [
      ...
      { value: DependentTypeKeys.ADULT, category: 'INSURED' } as any,
    ];
    component.currentInsuredTypeIndex = 0;
    (component as any).cvLevelId = 'CVL-1';
    (component as any).coverageVariantId = 'CV-1';
  ...
  it('should test _prepareCoverageFactorMapping', () => {
    const mockPayload = {
      insuredLevel: [
        {
          insuredType: { value: DependentTypeKeys.ADULT },
          limit: { maxAmount: 1000 },
        },
      ],
    } as any;
  ...
  it('should test getSelectedOption method', () => {
    ...
    component.retrieveDataOptions = [
      { code: DependentTypeKeys.ADULT, description: 'Adult' },
    ];

    const result = component['getSelectedOption']();

    expect(result).toBeDefined();
    expect(result?.code).toBe(DependentTypeKeys.ADULT);
  });
  ...
  it('should return ADULT from retrieveDataOptions if newRetrieveDataControl is empty', () => {
    component.retrieveDataOptions = [
    ...
    expect(component.getSelectedOption()?.code).toBe(DependentTypeKeys.ADULT);
  });
  ...
  it('should call submitSubCoverages if editedForm length > 0', async () => {
    ...
    component.activeInsuredType = { value: DependentTypeKeys.ADULT } as any;
