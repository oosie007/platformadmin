...
import { ChildVariantLevelComponent } from './child-variant-level.component';
...
const variantLevelId = 'CVL-8405AE52-FE4E-435B-A836-E804C80EC8DD';
...
describe('ChildVariantLevelComponent', () => {
  let component: ChildVariantLevelComponent;
  let fixture: ComponentFixture<ChildVariantLevelComponent>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(ChildVariantLevelComponent);
  ...
  it('_prefillSubCoverageForm should build controls based on subCoverage list', async () => {
    component.ngOnInit();
    const option = { code: DependentTypeKeys.CHILD } as any;
  ...
  it('submitSubCoverages should patch and show success, error branch should also navigate', async () => {
    ...
    await component.submitSubCoverages(
      ...
      req,
      { value: DependentTypeKeys.CHILD } as any,
      'CVL-1'
    );
    expect(mockLayoutService.showMessage).toHaveBeenCalled();
    // error
  ...
  it('should test _navigateIndividualVariantLevels', () => {
    component.selectedInsuredTypes = [
      ...
      { value: InsuredTypeKeys.SPOUSE, category: 'INSURED' } as any,
      { value: DependentTypeKeys.CHILD, category: 'INSURED' } as any,
    ];
    component.currentInsuredTypeIndex = 0;
    (component as any).cvLevelId = 'CVL-1';
    (component as any).coverageVariantId = 'CV-1';
  ...
  it('should test _prepareCoverageFactorMapping', () => {
    const mockPayload = {
      insuredLevel: [
        {
          insuredType: { value: DependentTypeKeys.CHILD },
          limit: { maxAmount: 1000 },
        },
      ],
    } as any;
  ...
  it('should test getSelectedOption method', () => {
    ...
    component.retrieveDataOptions = [
      { code: DependentTypeKeys.CHILD, description: 'Child' },
    ];

    const result = component['getSelectedOption']();

    expect(result).toBeDefined();
    expect(result?.code).toBe(DependentTypeKeys.CHILD);
  });
  ...
  it('should return CHILD from retrieveDataOptions if newRetrieveDataControl is empty', () => {
    component.retrieveDataOptions = [
      { code: InsuredTypeKeys.MAININSURED },
      { code: InsuredTypeKeys.SPOUSE },
      { code: DependentTypeKeys.CHILD },
    ] as any;
    component.newRetrieveDataControl = { value: '' } as any;
    expect(component.getSelectedOption()?.code).toBe(DependentTypeKeys.CHILD);
  });
  ...
  it('should return value from newRetrieveDataControl if present', () => {
    ...
    component.newRetrieveDataControl = {
      value: { code: InsuredTypeKeys.MAININSURED },
    } as any;
  ...
  it('should remove subcoverage directly if not SPOUSE', () => {
    component._initForm();
    component.addSubCoverage();
    const group: any = component.formArray.at(0);
    group.get('subCoverageLevelId')?.setValue('SCL-1');
  ...
  it('should call submitSubCoverages if editedForm length > 0', async () => {
    ...
    component.activeInsuredType = { value: DependentTypeKeys.CHILD } as any;
  ...
  describe('_observeAndSetValidators newRetrieveDataControl.valueChanges', () => {
    ...
    beforeEach(() => {
      ...
      component.retrieveDataOptions = [
        ...
        { code: InsuredTypeKeys.SPOUSE, description: 'Spouse' },
        { code: DependentTypeKeys.CHILD, description: 'Child' },
      ] as any;
